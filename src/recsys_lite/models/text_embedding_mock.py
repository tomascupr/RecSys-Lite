...
class TextEmbeddingModel(BaseRecommender):
    ...
    def __init__(
        ...
        item_text_fields: List[str] = ["title", "category", "brand"],
    ...
    def fit(self, user_item_matrix: sp.csr_matrix, **kwargs: Any) -> None:
        ...
        if n_items > 0:
            ...
            # Store item IDs
            self.item_ids = list(item_data.keys())
    ...
    def recommend(
        ...
        **kwargs: Any,
        ...
        filtered_indices = [i for i in all_item_indices 
                          if self.item_ids[i] not in interacted_item_ids]
